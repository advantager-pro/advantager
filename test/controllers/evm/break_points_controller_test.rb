...
class Advantager::EVM::BreakPointsControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create evm_break_point" do
    assert_difference('Advantager::EVM::BreakPoint.count') do
  ...
  test "should destroy evm_break_point" do
    assert_difference('Advantager::EVM::BreakPoint.count', -1) do
